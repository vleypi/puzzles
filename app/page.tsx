    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 space-y-9">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Tool href="create-set" title='Создать набор' description='Новый набор карточек' color='from-blue-600 to-blue-700 shadow-blue-600/25'>
          ...
          <Tool href="library" title='Библиотека' description='Библиотека ваших наборов' color='from-emerald-700 to-emerald-800 shadow-emerald-700/25'>
          ...
          <Tool href="statistics" title='Статистика' description='Узнать свою статистику' color='from-purple-600 to-purple-700 shadow-purple-600/25'>
          ...
          <Tool href="achievements" title='Достижения' description='Ваши достижения' color='from-orange-600 to-orange-700 shadow-orange-600/25'>
