    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 space-y-9">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Tool href="create-set" title='Тест' description='Проверить знания' color='from-purple-600 to-purple-700 shadow-purple-600/25'>
          ...
          <Tool href="create-set" title='Цели' description='Установить цели' color='from-orange-600 to-orange-700 shadow-orange-600/25'>
